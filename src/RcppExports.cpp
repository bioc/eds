...
RcppExport SEXP _eds_getSparseMatrix(SEXP numOfGenesSEXP, SEXP numOfOriginalCellsSEXP, SEXP countMatFilenameSEXP, SEXP tierImportSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_eds_getSparseMatrix", (DL_FUNC) &_eds_getSparseMatrix, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_eds(DllInfo *dll) {
